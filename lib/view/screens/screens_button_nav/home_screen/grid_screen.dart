      ...
      itemBuilder:
          (BuildContext context, int index) => Container(
            ...
            child: Column(
              ...
              children: [
                22.hi,
                Center(child: CustomImage(url: images[index], height: 100, width: 100)),
                Text(
                  " لمبات سنترا ليد قلاووظ \n كروي وورم مصري - 3 وات",
                  style: TextStyle(fontSize: 13, color: AppColors.titleLight),
                ),
                8.hi,
                Text("  5.25 ج.م", style: TextStyle(fontSize: 13, color: AppColors.primaryColor)),
                8.hi,
                Text(
                ...
                40.hi,
                Center(child: AppButton(onPressed: () {}, text: "50", color: Colors.white)),
              ],
            ),
          ),
    );
