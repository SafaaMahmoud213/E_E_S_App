      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text("2023-10-01", style: TextStyle(fontSize: 10.sp, color: AppColors.titleLight)),
            ],
          ),
        ),
        25.hi,
        if (isTrue)
          EasyStepper(
            ...
            steps: [
              EasyStep(
                customStep: CustomImage(url: AppImages.confirm, width: 24, height: 24),
                customTitle: Text(
              ...
              EasyStep(
                customStep: CustomImage(url: AppImages.onway, width: 24, height: 24),
                customTitle: Text(
                  textAlign: TextAlign.center,
                  "في الطريق",
                  style: TextStyle(
              ...
              EasyStep(
                customStep: CustomImage(url: AppImages.Status, width: 24, height: 24),
                customTitle: Text(
                  textAlign: TextAlign.center,
                  "تم تسليم الطلبية",
                  style: TextStyle(
        ...
        Row(
          children: [
            Container(
              ...
              width: 74.w,
              height: 80.h,
              child: Center(child: CustomImage(url: AppImages.logo2, width: 65.w, height: 20.h)),
            ),
            8.wi,
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Text.rich(
                  TextSpan(
                    text: "عدد المنتجات:  ",
                    style: TextStyle(fontSize: 13.sp, color: AppColors.titleLight),
                    children: [
                      TextSpan(
                        text: "3 منتجات",
