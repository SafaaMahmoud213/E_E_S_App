  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        image: DecorationImage(image: AssetImage(shape[current]), fit: BoxFit.cover),
      ),
      child: Scaffold(
                ...
                ...List.generate(
                  ...
                  (index) => Padding(
                    ...
                    child: CircleAvatar(
                      radius: 5.r,
                      backgroundColor:
                          index == current ? AppColors.primaryColor : AppColors.titleLight,
                    ),
                  ),
                ),
              Spacer(),
