...
import 'package:my_app/core/widgets/scaffold_messanger.dart';
import 'package:my_app/features/auth/presentation/widgets/another_account_text_signup.dart';
          ...
          BlocConsumer<SignupCubit, SignupState>(
            listener: (context, state) {
              if (state is SignupFailure) {
                CustomScaffoldMessanger(context, state.message);
              }
