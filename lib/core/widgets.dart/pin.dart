...
class _PinputExampleState extends State<PinputExample> {
  ...
  Widget build(BuildContext context) {
    final defaultPinTheme = PinTheme(
      width: 44,
      height: 44,
      textStyle: const TextStyle(fontSize: 22, color: AppColors.textColor),
          ...
          Directionality(
            ...
            child: Pinput(
              ...
              cursor: Column(
                ...
                children: [Container(width: 22, height: 1, color: Colors.white)],
              ),
                  ...
                  : AppButton(
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        context.read<PinputCubit>().checkPin(pinController.text);
                      }
                    },
                    text: "تأكيد",
                  );
